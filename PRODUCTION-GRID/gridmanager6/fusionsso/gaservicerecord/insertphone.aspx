...
<form id="form1" runat="server">
	<div class="auto-style1">
		...
		<br><br>COCKY ENTERPRISES <br>PHONE MANAGEMENT<br><br>
		<div class="auto-style1">
		</div>
	</div>
	<div align="center">
	<asp:SqlDataSource id="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="Dsn=GEMPROD" DeleteCommand="DELETE FROM [gphones] WHERE [id] = ? AND (([phoneid] = ?) OR ([phoneid] IS NULL AND ? IS NULL)) AND (([phonetype] = ?) OR ([phonetype] IS NULL AND ? IS NULL)) AND (([siteid] = ?) OR ([siteid] IS NULL AND ? IS NULL)) AND (([description] = ?) OR ([description] IS NULL AND ? IS NULL)) AND (([ipaddress] = ?) OR ([ipaddress] IS NULL AND ? IS NULL)) AND (([telemetryipaddress] = ?) OR ([telemetryipaddress] IS NULL AND ? IS NULL)) AND (([vpnid1] = ?) OR ([vpnid1] IS NULL AND ? IS NULL)) AND (([vpnid2] = ?) OR ([vpnid2] IS NULL AND ? IS NULL)) AND (([lat] = ?) OR ([lat] IS NULL AND ? IS NULL)) AND (([long] = ?) OR ([long] IS NULL AND ? IS NULL)) AND (([inventoryid] = ?) OR ([inventoryid] IS NULL AND ? IS NULL))" InsertCommand="INSERT INTO [gphones] ([phoneid], [phonetype], [siteid], [description], [ipaddress], [telemetryipaddress], [vpnid1], [vpnid2], [lat], [long], [inventoryid]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.Odbc" SelectCommand="SELECT * FROM [gphones]" UpdateCommand="UPDATE [gphones] SET [phoneid] = ?, [phonetype] = ?, [siteid] = ?, [description] = ?, [ipaddress] = ?, [telemetryipaddress] = ?, [vpnid1] = ?, [vpnid2] = ?, [lat] = ?, [long] = ?, [inventoryid] = ? WHERE [id] = ? AND (([phoneid] = ?) OR ([phoneid] IS NULL AND ? IS NULL)) AND (([phonetype] = ?) OR ([phonetype] IS NULL AND ? IS NULL)) AND (([siteid] = ?) OR ([siteid] IS NULL AND ? IS NULL)) AND (([description] = ?) OR ([description] IS NULL AND ? IS NULL)) AND (([ipaddress] = ?) OR ([ipaddress] IS NULL AND ? IS NULL)) AND (([telemetryipaddress] = ?) OR ([telemetryipaddress] IS NULL AND ? IS NULL)) AND (([vpnid1] = ?) OR ([vpnid1] IS NULL AND ? IS NULL)) AND (([vpnid2] = ?) OR ([vpnid2] IS NULL AND ? IS NULL)) AND (([lat] = ?) OR ([lat] IS NULL AND ? IS NULL)) AND (([long] = ?) OR ([long] IS NULL AND ? IS NULL)) AND (([inventoryid] = ?) OR ([inventoryid] IS NULL AND ? IS NULL))">
		<DeleteParameters>
			<asp:Parameter Name="original_id" Type="Int32" />
			<asp:Parameter Name="original_phoneid" Type="String" />
			<asp:Parameter Name="original_phoneid" Type="String" />
			<asp:Parameter Name="original_phonetype" Type="Int32" />
			<asp:Parameter Name="original_phonetype" Type="Int32" />
		...
		<InsertParameters>
			<asp:Parameter Name="phoneid" Type="String" />
			<asp:Parameter Name="phonetype" Type="Int32" />
...
<a href="managephones.aspx">Return to Phone Manager</a>
</div>
</body>
</html>