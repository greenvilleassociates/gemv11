...
<form id="form1" runat="server">
	<div class="auto-style1">
		...
		<br><br><br><br>COCKY ENTERPRISES <br>COMPUTER MANAGER<br><br>
		<div class="auto-style1">
	...
	<asp:SqlDataSource id="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="Dsn=GEMPROD" DeleteCommand="DELETE FROM [gcomputer] WHERE [id] = ? AND (([computerid] = ?) OR ([computerid] IS NULL AND ? IS NULL)) AND (([computertype] = ?) OR ([computertype] IS NULL AND ? IS NULL)) AND (([siteid] = ?) OR ([siteid] IS NULL AND ? IS NULL)) AND (([description] = ?) OR ([description] IS NULL AND ? IS NULL)) AND (([ipaddress] = ?) OR ([ipaddress] IS NULL AND ? IS NULL)) AND (([telemetryipaddress] = ?) OR ([telemetryipaddress] IS NULL AND ? IS NULL)) AND (([vpnid1] = ?) OR ([vpnid1] IS NULL AND ? IS NULL)) AND (([vpnid2] = ?) OR ([vpnid2] IS NULL AND ? IS NULL))" InsertCommand="INSERT INTO [gcomputer] ([computerid], [computertype], [siteid], [description], [ipaddress], [telemetryipaddress], [vpnid1], [vpnid2]) VALUES (?, ?, ?, ?, ?, ?, ?, ?)" OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.Odbc" SelectCommand="SELECT * FROM [gcomputer]" UpdateCommand="UPDATE [gcomputer] SET [computerid] = ?, [computertype] = ?, [siteid] = ?, [description] = ?, [ipaddress] = ?, [telemetryipaddress] = ?, [vpnid1] = ?, [vpnid2] = ? WHERE [id] = ? AND (([computerid] = ?) OR ([computerid] IS NULL AND ? IS NULL)) AND (([computertype] = ?) OR ([computertype] IS NULL AND ? IS NULL)) AND (([siteid] = ?) OR ([siteid] IS NULL AND ? IS NULL)) AND (([description] = ?) OR ([description] IS NULL AND ? IS NULL)) AND (([ipaddress] = ?) OR ([ipaddress] IS NULL AND ? IS NULL)) AND (([telemetryipaddress] = ?) OR ([telemetryipaddress] IS NULL AND ? IS NULL)) AND (([vpnid1] = ?) OR ([vpnid1] IS NULL AND ? IS NULL)) AND (([vpnid2] = ?) OR ([vpnid2] IS NULL AND ? IS NULL))">
		<DeleteParameters>
...
<span><a href="insertcomputer.aspx">Insert a New Computer</a><BR></span>
<BR>
<HR>
