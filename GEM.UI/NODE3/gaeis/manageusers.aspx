...
<form id="form1" runat="server">
	<div class="auto-style1">
		...
		<br><br><br><br>COCKY ENTERPRISES <br>USER MANAGER<br><br>
		<div class="auto-style3">
			<asp:GridView id="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" DataKeyNames="id" DataSourceID="SqlDataSource1" Width="1408px" horizontalalign="Center" AllowPaging="True" CssClass="auto-style2" Font-Size="8pt">
				<Columns>
