...
<li><a href="#">590-MyLinkApp(SqlServer)</a></li>
<li><a href="#">547-CockyEntertainmentApp(MySql)</a></li>
<li><a href="#">498-GemApp(Postgres)</a></li>
...
<li><a href="https://gridmanager2.590team1.info/fusionsso/gridactions/controllershowuname.html" target="_self">BackupN2-DBInstances</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gridactions/controllershowuname.html" target="_self">OSInformation</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gridactions/controllershownetstat.html" target="_self">NetworkListeners</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gridactions/controllershowifconfig.html" target="_self">NetworkInterfaceDetail</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gridactions/controllershowgridinfo.html" target="_self">NetworkResponders</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gridactions/controllershowlatency.html">GridPeerResponsivenes</a></li>
<H3>Other Grid Actions</H3>
<li><a href="../gaservicerecord/insertinventory.aspx">Insert New Inventory Item</a></li>
<li><a href="../gaservicerecord/insertinventorytype.aspx">Insert New Inventory Type</a></li>
<li>Check Postgres Synch</a></li>
<li>Check Grid Applications For A Customer</a></li>
<li>Check Local NFS Mounts</a></li>
<li>Check Grid NFS Mounts</a></li>
...
<div class="column3">
<ul>
<H3>Grid Root Summary Data</H3>
<li><a href="#">GridInventorySummary</a></li>
<li><a href="#">GridHealth</a></li>
<li><a href="#">GridAppTotals</a></li>
<li><a href="#">GridDBMSInstances</a></li>
<H3>EIS Application Information</H3>
<li><a href="#">GridSSO</a></li>
<li><a href="#">GridVoice</a></li>
<li><a href="#">GridLogger</a></li>
<H3>Active Grid Information</H3>
<li><a href="#">1-Campus Grid</a></li>
<li><a href="#">2-North America Grid</a></li>
<li><a href="#">3-Amazon Global EurAmerica</a></li>
<H3>Reports</H3>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gareports/ComplianceReport.html">1-ApplicationComplianceBase</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gareports/ComplianceApiReport3.html">2-ApplicationComplianceAllApps</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gareports/ComplianceChart.html">3-GridAppsChart</a></li>
<li><a href="https://gridmanager2.590team1.info/fusionsso/gareports/ComplianceChart2.html">4-AppCompliance By Grid</a></li>
</ul>
</div>
<div class="column3">
<ul>
...
<br>
<hr>
<div align="center" class="informatica"><h2>FusionInformatica</h2></div>
<hr>

<button class="accordion">Sales Information</button>
<div class="panel">
  <p>A Large Sales Force Looks at Reps, Support Personel, Reps to Support Ratios, Quota Per Rep, Target Per Rep and Usually By Region...</p>
</div>
<hr>
	<button class="accordion">Operations Information</button>
	<div class="panel">
	<canvas id="myChart06" style="position: relative; height:80vh; width:80vw"></canvas>
	<br>
	<canvas id="myChart07" style="position: relative; height:80vh; width:80vw"></canvas>
	<br>
	<canvas id="myChart08" style="position: relative; height:80vh; width:80vw"></canvas>
	<br>
	</div>
<br><hr>
	
	<button class="accordion">Consumer</button>
	<div class="panel">
	<div class="row2">
	<div class="column2">
	...
	<div class="column2">
	 <h4>DBMS Information</h4>
	  <canvas id="myChart03" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>User Actions</h4>
	  <canvas id="myChart04" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>Factory Operations</h4>
	  <canvas id="myChart00" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	</div>
	</div>
<br><hr>
...
<button class="accordion">Wholesale</button>
<div class="panel">
<div class="row2">
	<div class="column2">
	 <h4>Account Actions</h4>
	  <canvas id="myChart21" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>Application Information</h4>
	  <canvas id="myChart22" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>DBMS Information</h4>
	  <canvas id="myChart23" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>User Actions</h4>
	  <canvas id="myChart24" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>Factory Operations</h4>
	  <canvas id="myChart25" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	</div>
	</div>
<br><hr>
<button class="accordion">Agents</button>
<div class="panel">
<div class="row2">
<div class="column2">
	 <h4>Account Actions</h4>
	  <canvas id="myChart11" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>Application Information</h4>
	  <canvas id="myChart12" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>DBMS Information</h4>
	  <canvas id="myChart13" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>User Actions</h4>
	  <canvas id="myChart14" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>Factory Operations</h4>
	  <canvas id="myChart15" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	</div>
	</div>
<br><hr>
<button class="accordion">Business Markets</button>
<div class="panel">
<div class="row2">
<div class="column2">
	 <h4>Account Actions</h4>
	  <canvas id="myChart16" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>Application Information</h4>
	  <canvas id="myChart17" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>DBMS Information</h4>
	  <canvas id="myChart18" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>User Actions</h4>
	  <canvas id="myChart19" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	<div class="column2">
	 <h4>Factory Operations</h4>
	  <canvas id="myChart20" style="position: relative; height:80vh; width:80vw"></canvas>
	</div>
	</div>
	</div>
<br><hr>
