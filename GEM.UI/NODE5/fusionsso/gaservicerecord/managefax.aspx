...
<form id="form1" runat="server">
	<div class="auto-style1">
		...
		<br><br><br><br>COCKY ENTERPRISES <br>FAX MANAGER <br><br>
		<div class="auto-style1">
			<asp:GridView id="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" DataKeyNames="id" DataSourceID="SqlDataSource1" Width="1408px" horizontalalign="Center" AllowPaging="True">
				<Columns>
					...
					<asp:BoundField DataField="faxid" HeaderText="faxid" SortExpression="faxid">
					</asp:BoundField>
					<asp:BoundField DataField="faxtype" HeaderText="faxtype" SortExpression="faxtype">
					</asp:BoundField>
	...
	<asp:SqlDataSource id="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="Dsn=GEM32" DeleteCommand="DELETE FROM [gfax] WHERE [id] = ? AND (([faxid] = ?) OR ([faxid] IS NULL AND ? IS NULL)) AND (([faxtype] = ?) OR ([faxtype] IS NULL AND ? IS NULL)) AND (([siteid] = ?) OR ([siteid] IS NULL AND ? IS NULL)) AND (([description] = ?) OR ([description] IS NULL AND ? IS NULL)) AND (([ipaddress] = ?) OR ([ipaddress] IS NULL AND ? IS NULL)) AND (([telemetryipaddress] = ?) OR ([telemetryipaddress] IS NULL AND ? IS NULL)) AND (([vpnid1] = ?) OR ([vpnid1] IS NULL AND ? IS NULL)) AND (([vpnid2] = ?) OR ([vpnid2] IS NULL AND ? IS NULL))" InsertCommand="INSERT INTO [gfax] ([faxid], [faxtype], [siteid], [description], [ipaddress], [telemetryipaddress], [vpnid1], [vpnid2]) VALUES (?, ?, ?, ?, ?, ?, ?, ?)" OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.Odbc" SelectCommand="SELECT * FROM [gfax]" UpdateCommand="UPDATE [gfax] SET [faxid] = ?, [faxtype] = ?, [siteid] = ?, [description] = ?, [ipaddress] = ?, [telemetryipaddress] = ?, [vpnid1] = ?, [vpnid2] = ? WHERE [id] = ? AND (([faxid] = ?) OR ([faxid] IS NULL AND ? IS NULL)) AND (([faxtype] = ?) OR ([faxtype] IS NULL AND ? IS NULL)) AND (([siteid] = ?) OR ([siteid] IS NULL AND ? IS NULL)) AND (([description] = ?) OR ([description] IS NULL AND ? IS NULL)) AND (([ipaddress] = ?) OR ([ipaddress] IS NULL AND ? IS NULL)) AND (([telemetryipaddress] = ?) OR ([telemetryipaddress] IS NULL AND ? IS NULL)) AND (([vpnid1] = ?) OR ([vpnid1] IS NULL AND ? IS NULL)) AND (([vpnid2] = ?) OR ([vpnid2] IS NULL AND ? IS NULL))">
		<DeleteParameters>
			<asp:Parameter Name="original_id" Type="Int32" />
			<asp:Parameter Name="original_faxid" Type="String" />
			<asp:Parameter Name="original_faxid" Type="String" />
			<asp:Parameter Name="original_faxtype" Type="Int32" />
			<asp:Parameter Name="original_faxtype" Type="Int32" />
		...
		<InsertParameters>
			<asp:Parameter Name="faxid" Type="String" />
			<asp:Parameter Name="faxtype" Type="Int32" />
...
<span><a href="insertfax.aspx">Insert a New Fax</a><BR></span>
<BR>
<HR>
