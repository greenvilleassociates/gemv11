...
public partial class GemContext : DbContext
{
    ...
    public virtual DbSet<Glicensetype> Glicensetypes { get; set; }
    ...
    public virtual DbSet<Grack> Gracks { get; set; }

    public virtual DbSet<Gregion> Gregions { get; set; }
    ...
    public virtual DbSet<Gworktype> Gworktypes { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder
            .HasPostgresExtension("snowflake", "snowflake")
            .HasPostgresExtension("spock", "spock");
        ...
        modelBuilder.Entity<Gapp>(entity =>
        {
            ...
            entity.Property(e => e.Legalcontactid).HasColumnName("legalcontactid");
            entity.Property(e => e.Licenseexpiration).HasColumnName("licenseexpiration");
            entity.Property(e => e.Licenseid)
                .HasMaxLength(150)
                .HasColumnName("licenseid");
            entity.Property(e => e.Licensetype).HasColumnName("licensetype");
            ...
            entity.Property(e => e.Targetgridid)
                .HasDefaultValue(1)
            ...
            entity.Property(e => e.Whynoncompliant)
                .HasMaxLength(500)
                .HasColumnName("whynoncompliant");
        });
        ...
        modelBuilder.Entity<Ghost>(entity =>
        {
            ...
            entity.Property(e => e.Switchid2)
                .HasMaxLength(50)
                .HasColumnName("switchid2");
            entity.Property(e => e.Telemetryipaddress)
                .HasMaxLength(50)
                .HasColumnName("telemetryipaddress");
            entity.Property(e => e.Vpnid1)
        ...
        modelBuilder.Entity<Glicensetype>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("glicensetype_pkey");

            entity.ToTable("glicensetype");
        ...
        modelBuilder.Entity<Grack>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("grack_pkey");

            entity.ToTable("grack");
        ...
        modelBuilder.Entity<Gregion>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("gregions_pkey");

            entity.ToTable("gregions");
        ...
        modelBuilder.Entity<Gsoftwarelicense>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("gsoftwarelicenses_pkey");

            entity.ToTable("gsoftwarelicenses");
            ...
            entity.Property(e => e.Technicalcontactid).HasColumnName("technicalcontactid");
            entity.Property(e => e.Totalseats).HasColumnName("totalseats");
            entity.Property(e => e.Vendorid).HasColumnName("vendorid");
        });
        ...
        modelBuilder.Entity<Gtrunk>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("gtrunks_pkey");

            entity.ToTable("gtrunks");
        ...
        modelBuilder.Entity<Gworktype>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("gworktype_pkey");

            entity.ToTable("gworktype");
        ...
        modelBuilder.Entity<HField>(entity =>
        {
            ...
            entity.Property(e => e.Description).HasColumnName("description");
            entity.Property(e => e.Fieldparams).HasColumnName("fieldparams");
            entity.Property(e => e.GroupId)
                .HasDefaultValue(0L)
        ...
        modelBuilder.Entity<HTemplateStyle>(entity =>
        {
            ...
            entity.Property(e => e.Home)
                ...
                .HasColumnName("home");
            entity.Property(e => e.Inheritable)
                .HasDefaultValue((short)0)
        ...
        modelBuilder.Entity<HUcmContent>(entity =>
        {
            ...
            entity.Property(e => e.CoreBody).HasColumnName("core_body");
            ...
            entity.Property(e => e.CoreImages).HasColumnName("core_images");
            entity.Property(e => e.CoreLanguage)
                .HasMaxLength(7)
                .HasDefaultValueSql("''::character varying")
                .HasColumnName("core_language");
            entity.Property(e => e.CoreMetadata).HasColumnName("core_metadata");
            entity.Property(e => e.CoreMetadesc).HasColumnName("core_metadesc");
            entity.Property(e => e.CoreMetakey).HasColumnName("core_metakey");
            ...
            entity.Property(e => e.CoreParams).HasColumnName("core_params");
            ...
            entity.Property(e => e.CoreUrls).HasColumnName("core_urls");
        ...
        modelBuilder.Entity<HUser>(entity =>
        {
            ...
            entity.HasIndex(e => e.Username, "h_users_idx_username").IsUnique();
        ...
        modelBuilder.Entity<Shadowuser>(entity =>
        {
            ...
            entity.Property(e => e.Name)
                .HasMaxLength(150)
                .HasColumnName("name");
            entity.Property(e => e.Originatingnode)
                .HasMaxLength(50)
                .HasColumnName("originatingnode");
            entity.Property(e => e.Otep)
                .HasMaxLength(1000)
                .HasColumnName("otep");
            entity.Property(e => e.Otpkey)
        ...
        {
            entity.HasKey(e => e.Id).HasName("trigger_log_pkey");
        ...
        modelBuilder.HasSequence("uid_seq").StartsAt(20000L);
